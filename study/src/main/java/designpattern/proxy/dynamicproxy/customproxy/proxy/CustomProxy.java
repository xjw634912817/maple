...
//        f.delete();
    ...
    private static String generateCode(Class<?>[] interfaces) {
        ...
        stringBuilder.append("package designpattern.proxy.dynamicproxy.customproxy.proxy;").append(LN)
                .append("import designpattern.proxy.dynamicproxy.customproxy.client.IPerson;").append(LN)
